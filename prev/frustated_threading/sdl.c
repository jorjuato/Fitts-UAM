...
//Cabeceras con definiciones del sistema grafico en el que trabajamos
#include "display.h"
#include "sdl.h"
...
static SDL_Surface* setup_sdl()
{
    ...
    if( !(screen = SDL_SetVideoMode(WIDTH, HEIGHT, video->vfmt->BitsPerPixel, SDL_HWSURFACE | SDL_DOUBLEBUF | SDL_FULLSCREEN)) ){
