...
#define LAST_CHANGE_INTERVAL	200
...
#define ID_MAX					6.0
#define ID_STEP					1.0
#define MIN_ID_STEP				0.001
#define ERROR_PERCENT			0.05
#define ERROR_MAX				15
#define OSCILLATIONS_BEFORE		20
#define	OSCILLATIONS_DURING		6
#define OSCILLATIONS_AFTER		20
#define TRIAL_TYPES				(int)(( (ID_MAX) - (ID_MIN) )* 2.0 / (ID_STEP))
#define TRIAL_REPLICATIONS		5
