...
#define LAST_CHANGE_INTERVAL	75
#define MAX_TRIAL_SAMPLES		1000000
#define ONE_MILLION				1000000
#define INTER_TRIAL_TIME 		2500
#define ERROR_SCREEN_TIME 		1500
